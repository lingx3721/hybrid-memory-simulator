 ...
 * 
 * conf file: /home/ling/githubs/hybrid-memory-simulator/config/new-machine/moesi.conf
 */
...
int nvmain_test_shared_l3_handle_cpuid(uint32_t index, uint32_t count, uint32_t *eax, uint32_t *ebx,
...
void gen_nvmain_test_shared_l3_machine(BaseMachine& machine)
{
    ...
    foreach(i, machine.get_num_cores()) {
        ...
        ControllerBuilder::add_new_cont(machine, i, "L1_I_", "moesi_cache", L1_32K_MOESI);
    ...
    foreach(i, machine.get_num_cores()) {
        ...
        ControllerBuilder::add_new_cont(machine, i, "L1_D_", "moesi_cache", L1_32K_MOESI);
    ...
    foreach(i, machine.get_num_cores()) {
        ...
        ControllerBuilder::add_new_cont(machine, i, "L2_", "moesi_cache", L2_512K_MOESI);
    ...
    foreach(i, 1) {
        ...
        ControllerBuilder::add_new_cont(machine, i, "L3_", "wb_cache", L3_2M);
    ...
    foreach(i, 1) {
        ...
        ControllerBuilder::add_new_cont(machine, i, "MEM_", "simple_nvm_cont", 0);
    ...
    machine.handle_cpuid = &nvmain_test_shared_l3_handle_cpuid;
...
MachineBuilder nvmain_test_shared_l3("nvmain_test_shared_l3", &gen_nvmain_test_shared_l3_machine);
